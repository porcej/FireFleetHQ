    ...
    if (typeof io !== 'undefined') {
        ...
        socket.on('scrape_update', function(data) {
            ...
            if (window.location.pathname.includes('/dashboard')) {
                ...
                if (typeof window.loadApparatusList === 'function') {
        ...
        socket.on('apparatus_updated', function() {
        ...
        socket.on('pstrax_alerts_updated', function() {
            if (window.location.pathname.includes('/pstrax-alerts') && typeof window.loadPstraxAlerts === 'function') {
                window.loadPstraxAlerts();
            }
        });
    }
}
