...
from app.models import Task, Alert
...
def emit_apparatus_updated():
    """Notify clients that the apparatus table was refreshed."""
    socketio.emit('apparatus_updated', {}, namespace='/')


def emit_pstrax_alerts_updated():
    """Notify clients that the PSTrax alerts table was refreshed."""
    socketio.emit('pstrax_alerts_updated', {}, namespace='/')
